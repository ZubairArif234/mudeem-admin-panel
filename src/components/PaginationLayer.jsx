...
export const SquarePagination = ({
  ...
  return (
    <ul className="pagination d-flex flex-wrap align-items-center gap-2 justify-content-center mt-24">
      ...
      <li className="page-item">
        <Link
          className="page-link bg-success-50 text-secondary-light fw-medium radius-8 border-0  py-10 d-flex align-items-center justify-content-center h-40-px w-40-px bg-success-600 text-white"
          to="#"
        >
          2
        </Link>
