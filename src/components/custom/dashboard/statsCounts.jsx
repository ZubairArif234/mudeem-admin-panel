              ...
              <div className="card-body p-0">
                <div className="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                  <div className="d-flex align-items-center gap-2">
                    <span className="mb-0 w-48-px h-48-px bg-success-500 flex-shrink-0 text-white d-flex justify-content-center align-items-center rounded-circle h6 mb-0 placeholder-glow">
                      <div className="placeholder" style={{ width: "100%", height: "100%", borderRadius: "50%" }} />
                    </span>
                    <div>
                      <span className="mb-2 fw-medium text-secondary-light text-sm placeholder-glow">
                        <div className="placeholder col-8" />
                      </span>
                      <h6 className="fw-semibold placeholder-glow">
                  ...
                  <div
                    id="new-user-chart"
                    className="remove-tooltip-title rounded-tooltip-value placeholder-glow"
                  >
                    <div className="placeholder" style={{ width: "100%", height: "100%" }} />
                  </div>
                </div>
                <p className="text-sm mb-0 placeholder-glow">
